...
void CSmokeUI::Late_Update(void)
{
}

void CSmokeUI::Render(HDC hDC)
{
...
void CSmokeUI::Release(void)
{
}

bool CSmokeUI::Check_Sphere(CObj * pDest, INFO * pSour)
{
	// c^2 = a^2 + b^2
